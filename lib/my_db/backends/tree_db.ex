defmodule MyDb.Backends.TreeDb do
  ...
  def new(records) do
    from_records(new(), records)
  end

  defp from_records(db, []) do
    db
  end
  ...
  defp delete_node(:empty) do
    :empty
  end

  defp delete_node({_k, _v, :empty, :empty}) do
    :empty
  end

  defp delete_node({_k, _v, :empty, right}) do
    right
  end

  defp delete_node({_k, _v, left, :empty}) do
    left
  end
